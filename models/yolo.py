...
from models.utils import draw_detections
...
class YOLOv8Seg:
    ...
    def __init__(self, onnx_model):
        ...
        print("session", self.session.get_providers())
    ...
    def draw_and_visualize(self, im, bboxes, segments, vis=False, save=True, video=False):
        """
